...
/**
 * Param�trage d'un point d'encrage de l'agent.
 * @author npiedeloup
 * @version $Id: $
 */
public class AnalyticaSpyHookPoint {
	 ...
	 * @param subTypes Liste des sous-cat�gories
	 */
	...
	/**
	 * @return Nom de l'h�ritage (nullable)
	 */
	...
	/**
	 * @return Type de methods accept�s (! pour not): INIT, CLINIT, METHOD, ABSTRACT, FINAL, NATIVE, PRIVATE, PROTECTED, PUBLIC, STATIC, SYNCHRONIZED
	 */
	...
	/**
	 * @return Liste des sous-cat�gories : en syntaxe javassist
	 */
