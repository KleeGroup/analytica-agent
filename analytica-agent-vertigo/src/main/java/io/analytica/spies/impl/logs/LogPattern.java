...
final class LogPattern {
	 ...
	 * @param error Si correspond é une erreur
	 ...
	 * @param indexCategoryTerms Index du sous type dans la regexp (0 si pas utilisé)
	 * @param indexTime Index de la durée dans la regexp (0 si pas utilisé)
	 * @param processRoot Si correspond é une racine de process : généra un process contenant les log encapsulés
	 * @param cleanStack Si correspond é event réinitialisant les process débutés (ex : reboot serveur)
	 */
	...
	/**
	 *
	 * @return Si correspond é un json complet
	 */
	...
	/**
	 * @return Si correspond é une erreur
	 */
	...
	/**
	 * @return Si correspond é une ligne de début de process
	 */
	...
	/**
	 * @return Si correspond é une racine de process : généra un process contenant les log encapsulés
	 */
	...
	/**
	 * @return Si correspond é event réinitialisant les process débutés (ex : reboot serveur)
	 */
